...
<ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item aba">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#AGOSTO/2020" role="tab" aria-controls="profile" aria-selected="false">AGOSTO/2020</a>
                </li>

                <li class="nav-item aba">
                <a class="nav-link" id="profile-tab" data-toggle="tab" href="#JULHO/2020" role="tab" aria-controls="profile" aria-selected="false">JULHO/2020</a>
                </li>
 ...
 <!------------------------------------------------------ABA AGOSTO--------------------------------------------------------->
 <div class="tab-pane fade" id="AGOSTO/2020" role="tabpanel" aria-labelledby="profile-tab">
                        <br/>
                        <br/>
                        <p class="h5">REQUERIMENTOS</p>
                        <div class="border col embed-responsive embed-responsive-4by3 ">
                            
                            <div id="grafico_REQ-AGO20" class=" embed-responsive-item  "></div><!-- grafico Requerimentos  -->
                        </div>
                        <br/>
                        <br/>
                        ...
                        <div class="border col embed-responsive embed-responsive-4by3 ">
                            ...
                            <div id="grafico_I-AGO20" class=" embed-responsive-item  " ></div><!-- grafico imprensa  -->
                        </div>
                        <br/>
                        <br/>
                        ...
                        <div class="border col embed-responsive embed-responsive-4by3 "> 
                            ...
                            <div id="grafico_DG-AGO20" class=" embed-responsive-item  "></div><!-- grafico design gráfico  -->
                        </div> 
                        <br/>
                        <br/>
                        ...
                        <div class="border col embed-responsive embed-responsive-4by3 "> 
                            ...
                            <div id="grafico_FA-AGO20" class=" embed-responsive-item  "></div><!-- grafico fotografia e Audiovisual  -->
                        </div>  
                        <br/>
                        <br/>
                        ...
                        <div class="border col embed-responsive embed-responsive-4by3 ">
                            ...
                            <div id="grafico_MS-AGO20" class=" embed-responsive-item  "></div><!-- grafico midia social  -->
                        </div>
                        <br/>
                        <br/> 
                </div>
...
<!------------------------------------------------------ABA JULHO 2020--------------------------------------------------------->
 <div class="tab-pane fade" id="JULHO/2020" role="tabpanel" aria-labelledby="profile-tab">
                        <br/>
                        <br/>
                        <p class="h5">REQUERIMENTOS</p>
                        <div class="border col embed-responsive embed-responsive-4by3 ">
                            
                            <div id="grafico_REQ-JUL20" class=" embed-responsive-item  "></div><!-- grafico Requerimentos  -->
                        </div>
                        <br/>
                        <br/>
                        <p class="h5">IMPRENSA</p>  
                        <div class="border col embed-responsive embed-responsive-4by3 ">
                            ...
                            <div id="grafico_I-JUL20" class=" embed-responsive-item  " ></div><!-- grafico imprensa  -->
                        </div>
                        <br/>
                        <br/>
                        <p class="h5">DESIGN GRÁFICO</p>  
                        <div class="border col embed-responsive embed-responsive-4by3 "> 
                            ...
                            <div id="grafico_DG-JUL20" class=" embed-responsive-item  "></div><!-- grafico design gráfico  -->
                        </div> 
                        <br/>
                        <br/>
                        <p class="h5">FOTOGRAFIA E AUDIOVISUAL</p> 
                        <div class="border col embed-responsive embed-responsive-4by3 "> 
                            ...
                            <div id="grafico_FA-JUL20" class=" embed-responsive-item  "></div><!-- grafico fotografia e Audiovisual  -->
                        </div>  
                        <br/>
                        <br/>
                        <p class="h5">MÍDIA SOCIAL (*FACEBOOK)</p>  
                        <div class="border col embed-responsive embed-responsive-4by3 ">
                            ...
                            <div id="grafico_MS-JUL20" class=" embed-responsive-item  "></div><!-- grafico midia social  -->
                        </div>
                        <br/>
                        <br/> 
                </div>
