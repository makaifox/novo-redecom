 ...
 <!--------------------------------------------------ABA ANUAL 2020------------------------------------------------------->     
            <div class="tab-content " id="myTabContent">
                <div class="tab-pane fade show active" id="2020" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="border col "  id="chart_wrap" >
                        
                        <div id="grafico_REQAN-2020"class=" embed-responsive-item piechart" ></div><!-- grafico Requerimentos Anual -->
                    </div> 
                    <br/>
                    <br/>
		     <p class="h5">DEMANDAS</p>
                    <div class="border col  " id="chart_wrap">
                        ...
                        <div id="grafico_DEMANDA-2020" class=" embed-responsive-item piechart"></div><!-- grafico Demanda Anual -->
 ...
 <!------------------------------------------------------ABA JUNHO--------------------------------------------------------->
            <div class="tab-pane fade" id="JUNHO/2020" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="border col "  id="chart_wrap">
                            ...
                            <div id="grafico_REQ-JUN20" class=" embed-responsive-item piechart"></div><!-- grafico Requerimentos  -->
                        </div>
                        <br/>
                        <br/>
                        ...
                        <div class="border col "  id="chart_wrap">
                            ...
                            <div id="grafico_I-JUN20" class=" embed-responsive-item piechart" ></div><!-- grafico imprensa  -->
                        </div>
                        <br/>
                        <br/>
                        ...
                        <div class="border col "  id="chart_wrap"> 
                            ...
                            <div id="grafico_DG-JUN20" class=" embed-responsive-item piechart"></div><!-- grafico design gráfico  -->
                        </div> 
                        <br/>
                        <br/>
                        ...
                        <div class="border col "  id="chart_wrap"> 
                            ...
                            <div id="grafico_FA-JUN20" class=" embed-responsive-item piechart"></div><!-- grafico fotografia e Audiovisual  -->
                        </div>  
                        <br/>
                        <br/>
                        ...
                        <div class="border col "  id="chart_wrap">
                            ...
                            <div id="grafico_MS-JUN20" class=" embed-responsive-item piechart"></div><!-- grafico midia social  -->
                        </div>
                        <br/>
                        <br/> 
                </div>
 ...
 <!------------------------------------------------------ABA MAIO--------------------------------------------------------->
                <div class="tab-pane fade" id="MAIO/2020" role="tabpanel" aria-labelledby="profile-tab">
                        ...
                        <div class="border col "  id="chart_wrap">
                            ...
                            <div id="grafico_REQ-MAI20" class=" embed-responsive-item piechart"></div><!-- grafico Requerimentos  -->
                        </div>
                        <br/>
                        <br/>
                        <p class="h5">IMPRENSA</p>  
                        <div class="border col"   id="chart_wrap">
                            ...
                            <div id="grafico_I-MAI20" class=" embed-responsive-item piechart"></div><!-- grafico imprensa  -->
                        </div>
                        <br/>
                        <br/>
                        <p class="h5">DESIGN GRÁFICO</p>  
                        <div class="border col "  id="chart_wrap"> 
                            ...
                            <div id="grafico_DG-MAI20" class=" embed-responsive-item piechart"></div><!-- grafico design gráfico  -->
                        </div> 
                        <br/>
                        <br/>
                        <p class="h5">FOTOGRAFIA E AUDIOVISUAL</p> 
                        <div class="border col "  id="chart_wrap"> 
                            ...
                            <div id="grafico_FA-MAI20" class=" embed-responsive-item piechart"></div><!-- grafico fotografia e Audiovisual  -->
                        </div>  
                        <br/>
                        <br/>
                        <p class="h5">MÍDIA SOCIAL (*FACEBOOK)</p>  
                        <div class="border col "  id="chart_wrap">
                            ...
                            <div id="grafico_MS-MAI20" class=" embed-responsive-item piechart"></div><!-- grafico midia social  -->
                        </div>
                        <br/>
                        <br/> 
                </div>
...
<div class="tab-pane fade" id="ABRIL/2020" role="tabpanel" aria-labelledby="profile-tab">
    ...
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_REQ-ABR20" class=" embed-responsive-item piechart"></div><!-- grafico Requerimentos  -->
    </div>
    <br/>
    <br/>
    <p class="h5">IMPRENSA</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_I-ABR20" class=" embed-responsive-item piechart"></div><!-- grafico imprensa  -->
    </div>
    <br/>
    <br/>
    <p class="h5">DESIGN GRÁFICO</p>  
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_DG-ABR20" class=" embed-responsive-item piechart"></div><!-- grafico design gráfico  -->
    </div> 
    <br/>
    <br/>
    <p class="h5">FOTOGRAFIA E AUDIOVISUAL</p> 
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_FA-ABR20" class=" embed-responsive-item piechart"></div><!-- grafico fotografia e Audiovisual  -->
    </div>  
    <br/>
    <br/>
    <p class="h5">MÍDIA SOCIAL (*FACEBOOK)</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_MS-ABR20" class=" embed-responsive-item piechart"></div><!-- grafico midia social  -->
    </div>
    <br/>
    <br/> 
</div>
...
<div class="tab-pane fade" id="MARCO/2020" role="tabpanel" aria-labelledby="profile-tab">
    ...
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_REQ-MAR20" class=" embed-responsive-item piechart"></div><!-- grafico Requerimentos  -->
    </div>
    <br/>
    <br/>
    <p class="h5">IMPRENSA</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_I-MAR20" class=" embed-responsive-item piechart"></div><!-- grafico imprensa  -->
    </div>
    <br/>
    <br/>
    <p class="h5">DESIGN GRÁFICO</p>  
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_DG-MAR20" class=" embed-responsive-item piechart"></div><!-- grafico design gráfico  -->
    </div> 
    <br/>
    <br/>
    <p class="h5">FOTOGRAFIA E AUDIOVISUAL</p> 
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_FA-MAR20" class=" embed-responsive-item piechart"></div><!-- grafico fotografia e Audiovisual  -->
    </div>  
    <br/>
    <br/>
    <p class="h5">MÍDIA SOCIAL (*FACEBOOK)</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_MS-MAR20" class=" embed-responsive-item piechart"></div><!-- grafico midia social  -->
    </div>
    <br/>
    <br/> 
</div>
...
<div class="tab-pane fade" id="FEVEREIRO/2020" role="tabpanel" aria-labelledby="profile-tab">
    ...
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_REQ-FEV20" class=" embed-responsive-item piechart"></div><!-- grafico Requerimentos  -->
    </div>
    <br/>
    <br/>
    <p class="h5">IMPRENSA</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_I-FEV20" class=" embed-responsive-item piechart"></div><!-- grafico imprensa  -->
    </div>
    <br/>
    <br/>
    <p class="h5">DESIGN GRÁFICO</p>  
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_DG-FEV20" class=" embed-responsive-item piechart"></div><!-- grafico design gráfico  -->
    </div> 
    <br/>
    <br/>
    <p class="h5">FOTOGRAFIA E AUDIOVISUAL</p> 
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_FA-FEV20" class=" embed-responsive-item piechart"></div><!-- grafico fotografia e Audiovisual  -->
    </div>  
    <br/>
    <br/>
    <p class="h5">MÍDIA SOCIAL (*FACEBOOK)</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_MS-FEV20" class=" embed-responsive-item piechart"></div><!-- grafico midia social  -->
    </div>
    <br/>
    <br/> 
</div>
...
<div class="tab-pane fade" id="JANEIRO/2020" role="tabpanel" aria-labelledby="profile-tab">
    ...
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_REQ-JAN20" class=" embed-responsive-item piechart"></div><!-- grafico Requerimentos  -->
    </div>
    <br/>
    <br/>
    <p class="h5">IMPRENSA</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_I-JAN20" class=" embed-responsive-item piechart"></div><!-- grafico imprensa  -->
    </div>
    <br/>
    <br/>
    <p class="h5">DESIGN GRÁFICO</p>  
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_DG-JAN20" class=" embed-responsive-item piechart"></div><!-- grafico design gráfico  -->
    </div> 
    <br/>
    <br/>
    <p class="h5">FOTOGRAFIA E AUDIOVISUAL</p> 
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_FA-JAN20" class=" embed-responsive-item piechart"></div><!-- grafico fotografia e Audiovisual  -->
    </div>  
    <br/>
    <br/>
    <p class="h5">MÍDIA SOCIAL (*FACEBOOK)</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_MS-JAN20" class=" embed-responsive-item piechart"></div><!-- grafico midia social  -->
    </div>
    <br/>
    <br/> 
</div>
...
<div class="tab-pane fade" id="DEZEMBRO/2019" role="tabpanel" aria-labelledby="profile-tab">
    ...
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_REQ-DEZ19" class=" embed-responsive-item piechart"></div><!-- grafico Requerimentos  -->
    </div>
    <br/>
    <br/>
    <p class="h5">IMPRENSA</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_I-DEZ19" class=" embed-responsive-item piechart"></div><!-- grafico imprensa  -->
    </div>
    <br/>
    <br/>
    <p class="h5">DESIGN GRÁFICO</p>  
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_DG-DEZ19" class=" embed-responsive-item piechart"></div><!-- grafico design gráfico  -->
    </div> 
    <br/>
    <br/>
    <p class="h5">FOTOGRAFIA E AUDIOVISUAL</p> 
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_FA-DEZ19" class=" embed-responsive-item piechart"></div><!-- grafico fotografia e Audiovisual  -->
    </div>  
    <br/>
    <br/>
    <p class="h5">MÍDIA SOCIAL (*FACEBOOK)</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_MS-DEZ19" class=" embed-responsive-item piechart"></div><!-- grafico midia social  -->
    </div>
    <br/>
    <br/> 
</div>
...
<div class="tab-pane fade" id="NOVEMBRO/2019" role="tabpanel" aria-labelledby="profile-tab">
    ...
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_REQ-NOV19" class=" embed-responsive-item piechart"></div><!-- grafico Requerimentos  -->
    </div>
    <br/>
    <br/>
    <p class="h5">IMPRENSA</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_I-NOV19" class=" embed-responsive-item piechart"></div><!-- grafico imprensa  -->
    </div>
    <br/>
    <br/>
    <p class="h5">DESIGN GRÁFICO</p>  
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_DG-NOV19" class=" embed-responsive-item piechart"></div><!-- grafico design gráfico  -->
    </div> 
    <br/>
    <br/>
    <p class="h5">FOTOGRAFIA E AUDIOVISUAL</p> 
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_FA-NOV19" class=" embed-responsive-item piechart"></div><!-- grafico fotografia e Audiovisual  -->
    </div>  
    <br/>
    <br/>
    <p class="h5">MÍDIA SOCIAL (*FACEBOOK)</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_MS-NOV19" class=" embed-responsive-item piechart"></div><!-- grafico midia social  -->
    </div>
    <br/>
    <br/> 
</div>
...
<div class="tab-pane fade" id="OUTUBRO/2019" role="tabpanel" aria-labelledby="profile-tab">
    ...
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_REQ-OUT19" class=" embed-responsive-item piechart "></div><!-- grafico Requerimentos  -->
    </div>
    <br/>
    <br/>
    <p class="h5">IMPRENSA</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_I-OUT19" class=" embed-responsive-item piechart"></div><!-- grafico imprensa  -->
    </div>
    <br/>
    <br/>
    <p class="h5">DESIGN GRÁFICO</p>  
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_DG-OUT19" class=" embed-responsive-item piechart"></div><!-- grafico design gráfico  -->
    </div> 
    <br/>
    <br/>
    <p class="h5">FOTOGRAFIA E AUDIOVISUAL</p> 
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_FA-OUT19" class=" embed-responsive-item piechart"></div><!-- grafico fotografia e Audiovisual  -->
    </div>  
    <br/>
    <br/>
    <p class="h5">MÍDIA SOCIAL (*FACEBOOK)</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_MS-OUT19" class=" embed-responsive-item piechart"></div><!-- grafico midia social  -->
    </div>
    <br/>
    <br/> 
</div>
...
<div class="tab-pane fade" id="SETEMBRO/2019" role="tabpanel" aria-labelledby="profile-tab">
    ...
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_REQ-SET19" class=" embed-responsive-item piechart"></div><!-- grafico Requerimentos  -->
    </div>
    <br/>
    <br/>
    <p class="h5">IMPRENSA</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_I-SET19" class=" embed-responsive-item piechart"></div><!-- grafico imprensa  -->
    </div>
    <br/>
    <br/>
    <p class="h5">DESIGN GRÁFICO</p>  
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_DG-SET19" class=" embed-responsive-item piechart"></div><!-- grafico design gráfico  -->
    </div> 
    <br/>
    <br/>
    <p class="h5">FOTOGRAFIA E AUDIOVISUAL</p> 
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_FA-SET19" class=" embed-responsive-item piechart"></div><!-- grafico fotografia e Audiovisual  -->
    </div>  
    <br/>
    <br/>
    <p class="h5">MÍDIA SOCIAL (*FACEBOOK)</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_MS-SET19" class=" embed-responsive-item piechart"></div><!-- grafico midia social  -->
    </div>
    <br/>
    <br/> 
</div>
...
<div class="tab-pane fade" id="AGOSTO/2019" role="tabpanel" aria-labelledby="profile-tab">
    ...
    <div class="border col " id="chart_wrap">
        ...
        <div id="grafico_REQ-AGO19" class=" embed-responsive-item piechart"></div><!-- grafico Requerimentos  -->
    </div>
    <br/>
    <br/>
    <p class="h5">IMPRENSA</p>  
    <div class="border col " id="chart_wrap">
        ...
        <div id="grafico_I-AGO19" class=" embed-responsive-item piechart"></div><!-- grafico imprensa  -->
    </div>
    <br/>
    <br/>
    <p class="h5">DESIGN GRÁFICO</p>  
    <div class="border col " id="chart_wrap"> 
        ...
        <div id="grafico_DG-AGO19" class=" embed-responsive-item piechart"></div><!-- grafico design gráfico  -->
    </div> 
    <br/>
    <br/>
    <p class="h5">FOTOGRAFIA E AUDIOVISUAL</p> 
    <div class="border col " id="chart_wrap"> 
        ...
        <div id="grafico_FA-AGO19" class=" embed-responsive-item piechart"></div><!-- grafico fotografia e Audiovisual  -->
    </div>  
    <br/>
    <br/>
    <p class="h5">MÍDIA SOCIAL (*FACEBOOK)</p>  
    <div class="border col " id="chart_wrap">
        ...
        <div id="grafico_MS-AGO19" class=" embed-responsive-item piechart"></div><!-- grafico midia social  -->
    </div>
    <br/>
    <br/> 
</div>
...
<div class="tab-pane fade" id="JULHO/2019" role="tabpanel" aria-labelledby="profile-tab">
    ...
    <div class="border col " id="chart_wrap">
        ...
        <div id="grafico_REQ-JUL19" class=" embed-responsive-item piechart"></div><!-- grafico Requerimentos  -->
    </div>
    <br/>
    <br/>
    <p class="h5">IMPRENSA</p>  
    <div class="border col " id="chart_wrap">
        ...
        <div id="grafico_I-JUL19" class=" embed-responsive-item piechart"></div><!-- grafico imprensa  -->
    </div>
    <br/>
    <br/>
    <p class="h5">DESIGN GRÁFICO</p>  
    <div class="border col " id="chart_wrap"> 
        ...
        <div id="grafico_DG-JUL19" class=" embed-responsive-item piechart"></div><!-- grafico design gráfico  -->
    </div> 
    <br/>
    <br/>
    <p class="h5">FOTOGRAFIA E AUDIOVISUAL</p> 
    <div class="border col "  id="chart_wrap"> 
        ...
        <div id="grafico_FA-JUL19" class=" embed-responsive-item piechart"></div><!-- grafico fotografia e Audiovisual  -->
    </div>  
    <br/>
    <br/>
    <p class="h5">MÍDIA SOCIAL (*FACEBOOK)</p>  
    <div class="border col "  id="chart_wrap">
        ...
        <div id="grafico_MS-JUL19" class=" embed-responsive-item piechart"></div><!-- grafico midia social  -->
    </div>
    <br/>
    <br/> 
</div>
